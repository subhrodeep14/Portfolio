    ...
    <div className="min-h-screen bg-zinc-900 text-yellow-50  ">
      ...
      <div className="flex justify-center items-center align-middle mt-40">
        <div>
          ...
          <p className="text-lg mt-4 text-zinc-400">I develop open-source full-stack apps/tools and occasionally take on freelance projects.</p>
          <Link to='/contact' className="mt-6 inline-block bg-white text-blue-500 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200">
            Contact Me
          </Link>
