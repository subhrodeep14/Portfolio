    ...
    <div id="projects" className="py-16 min-h-screen bg-zinc-900 text-gray-300">
      <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center mt-14 flex-wrap gap-8 pt-5">
            ...
            <Cards image={assets.real}techs={project1} description={'A real estate website that helps you find the best property for you'}  text={'Real Estate 2'} pageLink={"https://real-estate-nine-blush.vercel.app/"} gitLink={'https://github.com/subhrodeep14/Real-Estate'}/>
