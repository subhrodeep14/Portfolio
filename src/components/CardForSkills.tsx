...
const CardForSkills = ({text,image}) => {
  return (
    <div className='p-2 w-48 h-56  border-none bg-zinc-800 text-white flex flex-col justify-center items-center gap-7 rounded-lg hover:bg-zinc-600 hover:w-52 hover:h-60 hover:cursor-pointer'>
